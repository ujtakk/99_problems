 ...
 *******************************************************************************
 *
 * ![](../../img/tree-layout2.gif "Binary Tree Grid")
 *
 * An alternative layout method is depicted in this illustration. Find out
 * the rules and write the corresponding OCaml function.
 *
