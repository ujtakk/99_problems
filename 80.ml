 ...
 *   is represented as `(x,y)`, the couple `(y,x)` is not present. The
 *   **graph-term form is our default representation.** You may want to
 *   define a similar type using sets instead of lists.
 *
